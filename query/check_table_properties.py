...
def check_table_properties(table_name):
    """
    Check tblproperties of a table on the Data Warehouse.

    Displays important properties:
    ...
    # Parse result: each row is [key, value]
    props = {}
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Check tblproperties of a table on the Data Warehouse"
    )
