...
export HADOOP_NAMENODE_OPTS="-Xms4g -Xmx10g -XX:+UseG1GC -XX:MaxGCPauseMillis=200 -XX:+UnlockExperimentalVMOptions -XX:G1HeapRegionSize=32M -XX:InitiatingHeapOccupancyPercent=45 -XX:+ExplicitGCInvokesConcurrent"
export HADOOP_DATANODE_OPTS="-Xms2g -Xmx4g"
export HADOOP_SECONDARYNAMENODE_OPTS="-Xms2g -Xmx4g -XX:+UseG1GC -XX:MaxGCPauseMillis=200"
...
export HADOOP_OPTS="$HADOOP_OPTS -Dhive.postgres.db.password=${POSTGRES_PASSWORD}"
