"""
Setup Metabase on-premise: create admin account, connect SparkSQL and Trino,
...
def check_already_setup(base_url):
    """Check if Metabase already has an admin account."""
...
def add_databases(base_url, session_id):
    """Add SparkSQL and Trino databases."""
...
def setup_cli(base_url, api_key):
    """Authenticate Metabase CLI (`mb`) with API key."""
    print("[5/5] Setting up Metabase CLI...")

    # Check if mb is installed
    try:
